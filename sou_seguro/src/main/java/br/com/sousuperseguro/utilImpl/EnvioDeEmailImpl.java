...
//		email.setSSLOnConnect(true);
		...
		try {
			...
			email.setHtmlMsg("<!DOCTYPE html>"
					...
					+ "<p>Após o pagamento da primeira parcela, você já poderá utilizar o atendimento de urgência e emergência, para as demais coberturas não deixe de acessar o link abaixo e consultar as Condições Gerais do seu plano.</p>"
					...
					+ "<li>Consulta �s condições gerais do plano contratado e procedimentos cobertos;</li>"
...
//					email.addBcc("anapaula.martins@supersegurocorretora.com.br");
					email.addBcc("thiago@supersegurocorretora.com.br");
