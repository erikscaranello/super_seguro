			...
			if(cell != null) {
				...
				if(cellValue != null && ! cellValue.isEmpty() && !cellValue.contains("CSTATUS")) {
					...
					if(	uploadDeArquivosRepository.obterRecebidoPorCpf(this.verificarCpf(linhaRecebida.getCell(6).getStringCellValue().replace(".", "").replace("-", ""))) == null) {
						...
						recebidoSouSuperSeguro.setCpf(linhaRecebida.getCell(6).getStringCellValue().isEmpty() ? null : this.verificarCpf(linhaRecebida.getCell(6).getStringCellValue().replace(".", "").replace("-", "")));
						...
						recebidoSouSuperSeguroCobranca.setCpfCobr(linhaRecebida.getCell(20).getStringCellValue().isEmpty() ? null : this.verificarCpf(linhaRecebida.getCell(20).getStringCellValue().replace(".", "").replace("-", "")));
						...
						recebidoSouSuperSeguroMensalidade.setCpfTitCorrente(linhaRecebida.getCell(39).getStringCellValue().isEmpty() ? null : this.verificarCpf(linhaRecebida.getCell(39).getStringCellValue().replace(".", "").replace("-", "")));
