...
@Entity
@Table(name="recebido_sou_super_seguro_cobranca")
public class RecebidoSouSuperSeguroCobranca implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4923299920706366283L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private BigInteger id;
	
	@Column(name="nm_cobr", nullable=false, length=70)
	private String nmCobr;
	
	@Column(name="dt_nasc_cobr", nullable=false)
	private Calendar dtNascCobr;
	
	@Column(name="cpf_cobr", nullable=false, length=11)
	private String cpfCobr;
	
	@Column(name="r_lograd_cobr", nullable=false, length=50)
	private String rLogradCobr;
	
	@Column(name="r_numero_cobr", nullable=false, length=10)
	private String rNumeroCobr;
	
	@Column(name="comp_cobr", nullable=true, length=15)
	private String compCobr;
	
	@Column(name="bairro_cobr", nullable=false, length=30)
	private String bairroCobr;
	
	@Column(name="cidade_cobr", nullable=false, length=30)
	private String cidadeCobr;
	
	@Column(name="id_cidade_cobr", nullable=true, length=7)
	private BigInteger idCidadeCobr;
	
	@Column(name="uf_cobr", nullable=false, length=2)
	private String ufCobr;
	
	@Column(name="cep_cobr", nullable=false, length=11)
	...
	@Column(name="c_fone3", nullable=true, length=20)
	private String cFone3;
	
	@Column(name="email", nullable=true, length=50)
	private String email;
	
	@Column(name="dia_venc", nullable=true, length=2)
	private Calendar diaVenc;
	
	@Column(name="data_inicio_cobr", nullable=true, length=10)
